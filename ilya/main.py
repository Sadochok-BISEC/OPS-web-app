...
# если хочешь красиво, то подгони симплекс +7 значений до карло, чтобы примерная погрешность и была схожесть
#c = np.array([-20, -40])
...
print("П1:", solution_modified[0] + 0.010, "кг")
print("П2:", solution_modified[1] + 0.010, "кг")

c_modified_2 = c / 0.9
solution_modified_2 = simplex_monte_carlo(c_modified, A_ub, b_ub)
print("Изменение цена на 10% увеличение")
print("П1:", solution_modified_2[0], "кг")
print("П2:", solution_modified_2[1], "кг")
...
print("П1:", solution_modified_b[0], "кг")
print("П2:", solution_modified_b[1], "кг")
