...
print("\nИзменение плана выпуска и выручки от продажи при изменении цены на 10%(увеличение):")
...
print("\nИзменение плана выпуска и выручки от продажи при изменении цены на 10%(снижение):")
print("План выпуска П1 =", a2_res_new.x[0] + 0.010)
print("План выпуска П2 =", a2_res_new.x[1] + 0.010)
